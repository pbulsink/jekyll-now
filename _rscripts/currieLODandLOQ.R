### Functions for Currie estimation of LOD/LOQ From Rajakovic et. al., Talanta 102 (2012) 79-87. doi:10.1016/j.talanta.2012.08.016 and Currie, Anal.
### Chem. 40 (1968) 586-593 and Currie, Pure Appl. Chem. 67 (1995) 1699-1723 by Philip Bulsink
...
calculateCurrieLimits <- function(cal, falsePositive = 0.95, falseNegative = 0.99) {
    # input: list(x=..., y-...) with x, y values of calibration.  compoundname, stock calibration, dilutionfactor, response, dilutionfactor,response...
}
