...
For an arbitrary kingdom size, we can repeat this. We could repeat the above task for every kingdom size from one to one million, and plot the proportions to try understand the trend. 
...
proplist<-list()
for(i in c(2, seq(10, 100000, 100))){
    proplist[i]<-par_simulate(i, 100)
}