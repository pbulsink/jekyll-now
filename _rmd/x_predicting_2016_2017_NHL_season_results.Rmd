...
plotPredictions(nhl_2017_ten$standings, title="Results of Time-Weighted DC Prediction of 2016-2017", n_sims=1000)
```

```{r prediction2017_two, echo=FALSE}
plotPredictions(nhl_2017_two$standings, title="Results of Fast DC Prediction of 2016-2017", n_sims=1000)
```
