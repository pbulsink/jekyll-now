...
doDCPrediction<-function(df, xi=0){
    ...
    res <- optim(par=par.inits, fn=DCoptimFn, DCm=dcm, xi=xi, method = "BFGS", hessian=FALSE)
...
```{r current_standings, echo=FALSE, results="asis"}
library(pander)
panderOptions('round',2)
panderOptions('keep.trailing.zeros', TRUE)
panderOptions('table.split.table',Inf)
pandoc.table(nhl_2016_stats[,1:10], style="rmarkdown", caption="Current team standings")
```
...
```{r predict_remainder, results="asis"}
...
```{r predict_seasons, results="asis"}
...
pandoc.table(east_standings, style="rmarkdown", caption="Predicted Eastern Conference standings")
...
pandoc.table(west_standings, style="rmarkdown", caption="Predicted Western Conference standings")
```
...
```{r sim_season_mean, results="asis"}
