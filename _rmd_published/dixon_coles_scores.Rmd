...
pandoc.table(probability_matrix,style="rmarkdown",caption="Probability of specific score matrix")
```
...
pandoc.table(stats2015[c(1:9,12)],style="rmarkdown",caption="Table of statistics in 2015-2016 season to today.")
```
